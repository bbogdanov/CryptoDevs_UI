...
export const navigationChangedObservable = new Subject();
...
export const SignedIn = TabNavigator({
    ...
    navigationOptions: ({navigation}) => ({
        ...
        tabBarOnPress: (location) => {
            navigationChangedObservable.next();
            navigation.navigate(location.scene.route.key);
        }
    }),
